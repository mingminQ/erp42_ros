 ...
 * If the service is not available within @c 200ms, logs an error and shows a warning dialog.
 */
void erp42::FeedbackMonitor::read_serial_bridge_parameters()
{
    ...
    {
        ERP42_ERROR("FeedbackMonitor::read_serial_bridge_parameters() failed to read \"erp42_serial_bridge\" parameters");
        QMessageBox::warning(this, "ERROR", "Failed to read \"erp42_serial_bridge\" parameters");
    }
}
