...
#ifndef ERP42_GUI_CONTROLLER_HPP_
#define ERP42_GUI_CONTROLLER_HPP_
...
{
    /**
     * @brief ERP42 Qt5 GUI controller integrating a QDockWidget with an rclcpp::Node.
     ...
     */
    class Controller : public QDockWidget, public rclcpp::Node
    {
    // Qt5 Object macro
    Q_OBJECT
    ...
    private:
        ...
        std::unique_ptr<Ui::ControllerDockWidget> controller_widget_;
...
#endif // ERP42_GUI_CONTROLLER_HPP_