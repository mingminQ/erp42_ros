...
| ![Cannot handle /erp42/mode_command](/assets/mode_command_error.png)           | Furthermore, erp42_serial_bridge includes a service server for processing erp42_msgs/srv/ModeCommand. Therefore, if a request for erp42_msgs/srv/ModeCommand is sent without erp42_serial_bridge running, the above error message will appear. |
