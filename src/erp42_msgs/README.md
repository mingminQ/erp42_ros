...
| **emergency_stop** | bool | **On / Off** | Current control mode of the vehicle. **Ture** is **E-Stop On** and **false** is **E-Stop Off**. |
| **gear** | uint8 | **Drive / Neutral / Reverse** | Current control mode of the vehicle. **Ture** is **manual mode** and **false** is **auto mode**. |
