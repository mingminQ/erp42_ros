...
#define ERP42_DEBUG(msg, ...) erp42_util::print_log(__FILE__, __LINE__, erp42_util::LogLevel::DEBUG   , msg, ##__VA_ARGS__)
#define ERP42_INFO(msg, ...)  erp42_util::print_log(__FILE__, __LINE__, erp42_util::LogLevel::INFO    , msg, ##__VA_ARGS__)
#define ERP42_WARN(msg, ...)  erp42_util::print_log(__FILE__, __LINE__, erp42_util::LogLevel::WARNING , msg, ##__VA_ARGS__)
#define ERP42_ERROR(msg, ...) erp42_util::print_log(__FILE__, __LINE__, erp42_util::LogLevel::ERROR   , msg, ##__VA_ARGS__)
